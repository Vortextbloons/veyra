    ...
    <div ref={ref} className="relative">
      ...
      {open && !disabled && (
        <div
          role="listbox"
          aria-label="Mode"
          className="absolute bottom-full right-0 z-50 mb-1.5 w-60 overflow-hidden rounded-lg border border-[var(--color-border)] bg-[var(--color-panel)] p-1 shadow-xl shadow-black/40"
        >
          {MODES.map((m) => {
